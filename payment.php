	...
	if( tambah($_POST) > 0 ) {
		echo "
			<script>
				...
				document.location.href = 'cek_payment.php';
			</script>
		";
	} else {
		echo "
...
<body>
    ...
    <div class="flex flex-wrap justify-center">
        ...
        <form class="w-1/2" action="" method="post" enctype="multipart/form-data">
            <div class="relative z-0 w-full mt-6 mb-6 group">
                <select
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    name="choosedItem" id="choosedItem">
                    <option value="">- pilih kamar -</option>
                    <option value="1">Kamar 1 Lantai 1</option>
                    <option value="2">Kamar 2 Lantai 1</option>
                    <option value="3">Kamar 3 Lantai 1</option>
                    <option value="4">Kamar 1 Lantai 2</option>
                    <option value="5">Kamar 2 Lantai 2</option>
                    <option value="6">Kamar 3 Lantai 2</option>
                    <option value="7">Kamar 1 Lantai 3</option>
                    <option value="8">Kamar 2 Lantai 3</option>
                    <option value="9">Kamar 3 Lantai 3</option>
                </select>
                <label for="choosedItem"
                    class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Pilih
                    Kamar
                </label>
            </div>
            <div class="relative z-0 w-full mb-6 group">
                <input type="number" name="total_month" id="total_month"
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder=" " required />
                <label for="total_month"
                    class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Berapa
                    bulan anda ingin membayar?</label>
            </div>
            ...
            <div class="relative z-0 w-full mb-6 group">
                ...
                <label for="floating_company"
                    class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Upload
                    bukti pembayaran</label>
            </div>
            <button type="submit"
                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" name="send">Submit</button>
        </form>
