...
<body>
    ...
    <section
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative item">
            <a href="#"
    ...
    <div id="gallery" class="relative w-full mt-14" data-carousel="slide">
        <!-- Carousel wrapper -->
        <div class="relative h-48 overflow-hidden rounded-lg justify-center ml-2 mr-2">
            <!-- Item 1 -->
            <div class="hidden duration-700 ease-in-out" data-carousel-item="active">

                <a href="#"
                    class="flex flex-row items-center bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                    <img class="object-cover rounded-t-lg w-96 h-48 md:h-48 md:w-96 md:rounded-none md:rounded-l-lg"
                        src="images/home2.jpg" alt="">
                    <div class="flex flex-col justify-between p-4 leading-normal">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Fasilitas Lantai 1</h5>
                            <ul class="mb-3 ml-6 font-normal text-gray-700 dark:text-gray-400 list-disc">
                                <li>Fasilitas 1</li>
                                <li>Fasilitas 2</li>
                                <li>Fasilitas 3</li>
                            </ul>
            ...
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                ...
                <a href="#"
                    class="flex flex-row items-center bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                    <img class="object-cover w-96 rounded-t-lg h-48 md:h-48 md:w-96 md:rounded-none md:rounded-l-lg"
                        src="images/home2.jpg" alt="">
                        <div class="flex flex-col justify-between p-4 leading-normal">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Fasilitas Lantai 2</h5>
                            <ul class="mb-3 ml-6 font-normal text-gray-700 dark:text-gray-400 list-disc">
                                <li>Fasilitas 1</li>
                                <li>Fasilitas 2</li>
                                <li>Fasilitas 3</li>
            ...
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                ...
                <a href="#"
                    ...
                    <img class="object-cover w-96 rounded-t-lg h-48 md:h-48 md:w-96 md:rounded-none md:rounded-l-lg"
                        src="images/home2.jpg" alt="">
                        <div class="flex flex-col justify-between p-4 leading-normal">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Fasilitas Lantai 3</h5>
                            <ul class="mb-3 ml-6 font-normal text-gray-700 dark:text-gray-400 list-disc">
                                <li>Fasilitas 1</li>
                                <li>Fasilitas 2</li>
                                <li>Fasilitas 3</li>
